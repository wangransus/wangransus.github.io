...
PAGE_FACT_MARKERS = {
    ...
    "en": {
        ...
        "-zxxx": [r"2026\.04", "https://www.mdpi.com/journal/jfmk/special_issues/WY0Z1REVS9", r"2024\.04", "http://www.mechanobiology.cn/yyswlx/news/view/20240428141350001", r"2023\.11", "https://journals.sagepub.com/editorial-board/PIP"],
        "-jybj": [r"2013\.08\s*-\s*2017\.05", "University of Central Florida", "Exercise Physiology", "Jay Hoffman", "David Fukuda", r"2010\.09\s*-\s*2013\.06", "Beijing Sport University", "Sport Science", "Yang Hu", "Junqiang Qiu", r"2006\.09\s*-\s*2010\.06", "[Bb]achelor", "Yanchun Li"],
        "-kyxm": ["Ministry of Science and Technology", "National Key R&D Program", r"3\.62\s*million", "Shanghai Municipal Science and Technology Commission", r"0\.5\s*million", "Shanghai Sailing Program", r"0\.2\s*million", "Eliga Sports Technology", r"2\s*million", "Huawei Device", r"1\.41\s*million"],
